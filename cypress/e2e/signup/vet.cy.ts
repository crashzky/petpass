...
describe('Signup vet page', () => {
	...
	it('signup-vet-1: Write exist email to form', () => {
		cy.visit('http://localhost:3000/signup/vet');
	...
	it('signup-vet-3: Write correct data to form', () => {
		cy.visit('http://localhost:3000/signup/vet');
	...
	it('signup-vet-4: Open page with accessToken', () => {
