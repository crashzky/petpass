...
describe('Signup breeder page', () => {
	...
	it('signup-breeder-1: Write exist email to form', () => {
		cy.visit('http://localhost:3000/signup/breeder');
	...
	it('signup-breeder-2: Server error', () => {
		cy.visit('http://localhost:3000/signup/breeder');
	...
	it('signup-breeder-3: Write correct data to form', () => {
		cy.visit('http://localhost:3000/signup/breeder');
	...
	it('signup-breeder-4: Open page with accessToken', () => {
